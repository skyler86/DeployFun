...
docker build -f Dockerfile --build-arg jar_name=/var/jenkins_home/workspace/job-demo/target/prometheus-test-demo-0.0.1-SNAPSHOT.jar -t ${IMAGE_NAME}:${VERSION_ID} .
